...
export const computeGravity = (particle: Particle, particleList: Particle[]) => {
...
export const computeCollisions = (particle: Particle, particleList: Particle[]) => {
  particleList = particleList.filter(p => p !== particle)
...
export const inCollision = (particle: Particle, neighbour: Particle) => {
